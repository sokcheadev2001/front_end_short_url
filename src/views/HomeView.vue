  ...
  <div class="bg-white shadow-md p-8 rounded-md mb-10">
    <form @submit.prevent="submit">
      ...
      <div class="mb-4 flex">
        <input
          type="text"
          class="w-full bg-gray-200 appearance-none border-2 border-gray-200 py-4 px-6 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
          name="short_url"
